...
public class OrderService {
  ...
  private SequenceMapper sequenceMapper=appContext
			.getBean(SequenceMapper.class);
  
  private LineItemMapper lineItemMapper=appContext
			.getBean(LineItemMapper.class);
